...
function serialize_demo_user_LoginRequest(arg) {
  if (!(arg instanceof user_user_pb.LoginRequest)) {
...
function deserialize_demo_user_LoginRequest(buffer_arg) {
  return user_user_pb.LoginRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_demo_user_VerifyRequest(arg) {
  if (!(arg instanceof user_user_pb.VerifyRequest)) {
...
function deserialize_demo_user_VerifyRequest(buffer_arg) {
  return user_user_pb.VerifyRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_demo_user_VerifyResponse(arg) {
  if (!(arg instanceof user_user_pb.VerifyResponse)) {
...
function deserialize_demo_user_VerifyResponse(buffer_arg) {
  return user_user_pb.VerifyResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var UserSvcService = exports.UserSvcService = {
  ...
  login: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: user_user_pb.LoginRequest,
    responseType: user_user_pb.UserResponse,
  ...
  verify: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: user_user_pb.VerifyRequest,
    responseType: user_user_pb.VerifyResponse,
