...
var uibackend_uibackend_pb = require('../uibackend/uibackend_pb.js');

function serialize_demo_uibackend_ProductsRequest(arg) {
  if (!(arg instanceof uibackend_uibackend_pb.ProductsRequest)) {
...
function deserialize_demo_uibackend_ProductsRequest(buffer_arg) {
  return uibackend_uibackend_pb.ProductsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_demo_uibackend_ProductsResponse(arg) {
  if (!(arg instanceof uibackend_uibackend_pb.ProductsResponse)) {
...
function deserialize_demo_uibackend_ProductsResponse(buffer_arg) {
  return uibackend_uibackend_pb.ProductsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_demo_uibackend_TransactionsRequest(arg) {
  if (!(arg instanceof uibackend_uibackend_pb.TransactionsRequest)) {
...
function deserialize_demo_uibackend_TransactionsRequest(buffer_arg) {
  return uibackend_uibackend_pb.TransactionsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_demo_uibackend_TransactionsResponse(arg) {
  if (!(arg instanceof uibackend_uibackend_pb.TransactionsResponse)) {
...
function deserialize_demo_uibackend_TransactionsResponse(buffer_arg) {
  return uibackend_uibackend_pb.TransactionsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var UibackendSvcService = exports.UibackendSvcService = {
  getProducts: {
    ...
    requestType: uibackend_uibackend_pb.ProductsRequest,
    responseType: uibackend_uibackend_pb.ProductsResponse,
  ...
  getTransactions: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: uibackend_uibackend_pb.TransactionsRequest,
    responseType: uibackend_uibackend_pb.TransactionsResponse,
