...
function serialize_demo_project_CreateTagRequest(arg) {
  if (!(arg instanceof project_pb.CreateTagRequest)) {
...
function deserialize_demo_project_CreateTagRequest(buffer_arg) {
  return project_pb.CreateTagRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_demo_project_TagResponse(arg) {
  if (!(arg instanceof project_pb.TagResponse)) {
...
function deserialize_demo_project_TagResponse(buffer_arg) {
  return project_pb.TagResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var ProjectSvcService = exports.ProjectSvcService = {
  ...
  createTag: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: project_pb.CreateTagRequest,
    responseType: project_pb.TagResponse,
